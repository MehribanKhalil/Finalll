...
const RegisterSection = () => {
  return (
    <section className='register-section flex flex-col lg:flex-row' >
        <div  className='left-side w-full lg:w-1/2 bg-main-color p-24 text-center  '>
        ...
        <div className=' right-side  w-full lg:w-1/2 p-24  text-center  '>
            ...
            <form className=' flex flex-col max-w-[500px] mx-auto space-y-8' > 
                <input className=' px-4 py-2 font-semibold' type="text" name="" id="" placeholder='Course Name' />
                <input className=' px-4 py-2 font-semibold' type="text" name="" id="" placeholder='Category' />
                <input className=' px-4 py-2 font-semibold' type="text" name="" id="" placeholder='Degree' />
